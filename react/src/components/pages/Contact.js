  ...
  render() {
    return (
      <div className="reactPageScrollerComponent fifth-component">
        ...
        <div className="contact">
          ...
          <div className="bottom">
            ...
            <div className="icons">
              <a
                alt="Gihub"
                href="https://github.com/TroddenSpade"
                target="_blank"
              >
              ...
              <a
                alt="Steam"
                href="https://steamcommunity.com/profiles/76561198275819165"
                target="_blank"
              >
        ...
        <p className="copyright">Copyright ©2019 Parsa Samadnejad</p>
      </div>
    );
  }
}
